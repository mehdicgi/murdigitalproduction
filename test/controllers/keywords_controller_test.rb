...
class KeywordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create keyword" do
    assert_difference('Keyword.count') do
      post keywords_url, params: { keyword: { channel_id: @keyword.channel_id, word: @keyword.word } }
    end

    assert_redirected_to keyword_path(Keyword.last)
  end
  ...
  test "should update keyword" do
    patch keyword_url(@keyword), params: { keyword: { channel_id: @keyword.channel_id, word: @keyword.word } }
    assert_redirected_to keyword_path(@keyword)
  end
